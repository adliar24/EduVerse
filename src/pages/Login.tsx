    ...
    <div className="min-h-screen w-full flex flex-col lg:flex-row relative bg-gradient-to-br from-[#0F172A] via-[#1E3A8A] to-[#0F172A] font-sans overflow-hidden">
      ...
      <AnimatePresence>
        {isRedirecting && (
          ...
          >
            ...
            >
              <div className="w-20 h-20 bg-gradient-to-tr from-indigo-600 to-blue-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-indigo-500/40 border border-white/20 animate-pulse">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-4 py-8 sm:p-8 lg:p-24 overflow-y-auto relative z-10">
        ...
        <div className="relative z-30 w-full max-w-[340px] sm:max-w-md mx-auto bg-white/98 p-6 sm:p-9 rounded-[2.5rem] shadow-2xl border border-white/90 min-h-[400px] sm:min-h-[430px] flex flex-col justify-center">
              ...
              >
                ...
                <div className="grid gap-3.5 pt-1">
                  ...
                  <button
                    ...
                    className="group flex items-center gap-4 p-4 bg-slate-50 border border-slate-200/80 rounded-3xl text-left hover:border-indigo-600 hover:bg-indigo-50/40 hover:shadow-lg hover:shadow-indigo-500/10 transition-all duration-300 active:scale-[0.98] cursor-pointer"
                  >
                    <div className="w-11 h-11 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all shrink-0 shadow-sm">
            ...
            {view === 'login' && (
              ...
              >
                <button 
                  ...
                  className="inline-flex items-center gap-1.5 text-indigo-600 font-bold text-[11px] hover:text-indigo-700 transition-colors mb-5 group cursor-pointer"
                >
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <div className="relative group">
                      ...
                      <input type="email" required
                        className="w-full pl-10 pr-4 py-3 rounded-2xl border border-slate-200 bg-slate-50/70 outline-none focus:bg-white focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600/15 transition-all font-semibold text-xs sm:text-sm"
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative group">
                      <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 w-4 h-4 group-focus-within:text-indigo-600 transition-colors" />
                  ...
                  <button type="submit" disabled={loading}
                    className="w-full bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-700 text-white py-3.5 rounded-full font-extrabold text-xs sm:text-sm hover:scale-[1.01] active:scale-[0.98] transition-all shadow-lg shadow-indigo-600/25 flex items-center justify-center gap-2 disabled:opacity-50 mt-3 cursor-pointer border border-white/20"
                  >
              ...
              >
                ...
                <form onSubmit={handleStudentLogin} className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <div className="relative group">
                      <User className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 w-4 h-4 group-focus-within:text-indigo-600 transition-colors" />
          ...
          {/* Bottom Card Footer: Update Versi / Bersihkan Cache */}
          <div className="pt-4 mt-4 border-t border-slate-100 flex flex-col items-center text-center">
            <button
              type="button"
              onClick={handleClearCacheAndUpdate}
              disabled={isUpdatingCache}
              title="Klik untuk menghapus cache lama dan memuat versi sistem terbaru"
              className="group inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-50 hover:bg-indigo-50 border border-slate-200/80 hover:border-indigo-200 text-slate-500 hover:text-indigo-600 text-[11px] font-bold transition-all active:scale-95 cursor-pointer disabled:opacity-50"
            >
              <RefreshCw className={cn("w-3 h-3 transition-transform", isUpdatingCache ? "animate-spin text-indigo-600" : "group-hover:rotate-180 duration-500")} />
              <span>{isUpdatingCache ? 'Memperbarui...' : 'Perbarui Versi Baru'}</span>
            </button>
