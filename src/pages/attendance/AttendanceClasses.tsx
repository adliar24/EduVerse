                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pb-4">
                    ...
                    return (
                        ...
                        className={`w-full p-6 rounded-3xl border-2 transition-all cursor-pointer group relative overflow-hidden flex flex-col justify-between ${
                            ...
                            : 'bg-white text-gray-800 border-gray-200 hover:border-blue-300 hover:shadow-lg'
                        }`}
                        >
                            {isActive && (
                            ...
                            <div className="mb-2">
                                ...
                                <p className={`text-sm truncate font-medium mt-1 ${isActive ? 'text-blue-100' : 'text-gray-500'}`}>{cls.subject}</p>
                            </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <Card className="p-6 flex flex-col justify-center gap-4 bg-white border border-gray-100 shadow-sm lg:col-span-1">
                            ...
                            <div className="relative">
                                ...
                                <select 
                                    className="w-full bg-gray-50 border border-gray-200 text-gray-800 text-base rounded-xl pl-10 pr-4 py-3 outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer font-medium"
                                    value={statsClassId}
