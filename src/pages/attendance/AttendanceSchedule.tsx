      ...
      <div className="flex items-center gap-2">
        <div className="relative flex-1">
          <select 
            ...
            className="w-full appearance-none bg-white text-gray-900 border border-gray-200 rounded-2xl pl-2 pr-6 md:pl-4 md:pr-8 py-3 text-center font-bold text-base md:text-lg outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all cursor-pointer"
          >
...
export const Schedule: React.FC<Props> = ({ state, refresh, notify }) => {
  ...
  return (
    <div className="space-y-6 pb-24 md:pb-6 h-full">
      ...
      <Modal isOpen={isScheduleModalOpen} onClose={() => setIsScheduleModalOpen(false)} title={editingScheduleId ? "Edit Jadwal" : `Jadwal Hari ${activeDay}`}>
        <form onSubmit={handleSaveSchedule} className="flex flex-col gap-5">
           ...
           <div className="space-y-1.5">
             ...
             <select 
               className="w-full bg-white text-gray-900 border border-gray-200 rounded-2xl px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500"
               value={newClassId}
