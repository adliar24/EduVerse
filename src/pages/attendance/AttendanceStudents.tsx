          ...
          <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                {sortedClasses.map(c => {
                  ...
                  return (
                    <Card key={c.id} onClick={() => handleSelectClass(c.id)} className="relative group cursor-pointer hover:shadow-lg transition-all h-full border-gray-100 hover:border-blue-300">
