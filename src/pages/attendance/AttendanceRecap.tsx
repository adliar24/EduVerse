...
import { upsertRecord, deleteSession } from '../../services/dbAttendance';
              ...
              <div className="flex items-center gap-2 self-end md:self-auto">
                ...
                <div
                  className={`p-1 rounded-full transition-transform duration-300 ${
                    isSelected ? 'rotate-180 bg-blue-200/50 text-blue-700' : 'text-gray-300'
                  }`}
                >
              ...
              {[
                ...
                <button
                  ...
                  onClick={() => setExportFormat(f.id as any)}
                   className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-5 rounded-full text-sm font-bold border-2 transition-colors cursor-pointer ${
                    exportFormat === f.id 
                      ? 'border-blue-500 bg-[#3B66F5]/5 text-blue-700' 
                      : 'border-gray-200 text-gray-600 hover:border-gray-300'
                  }`}
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
          ...
          {exportPeriod === 'semester' && (
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 py-2.5 px-5 rounded-full text-sm font-bold border-2 transition-colors cursor-pointer ${
                  exportMonth === 0 
                    ? 'border-blue-500 bg-[#3B66F5]/5 text-blue-700' 
                    : 'border-gray-200 text-gray-600 hover:border-gray-300'
                }`}
