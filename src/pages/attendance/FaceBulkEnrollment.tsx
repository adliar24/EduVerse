...
import { setSkipSync, autoSyncToCloud, initDB } from '../../services/dbAttendance';
  ...
  return (
    <div className="space-y-6 pb-28">
      <Header 
        ...
        subtitle="Registrasi foto wajah siswa."
        rightAction={
          <div className="flex flex-wrap items-center gap-4">
            {selectedClassId && (
              <button 
                onClick={clearSelection} 
                className="text-xs font-bold text-gray-400 hover:text-red-500 transition-colors uppercase tracking-wider px-3 py-2 cursor-pointer" 
            ...
            <div className="relative min-w-[240px]">
              <select
                ...
                className="w-full h-11 px-5 rounded-xl border border-gray-200 bg-white focus:border-blue-500 transition-all text-sm font-bold appearance-none shadow-sm cursor-pointer"
                disabled={isProcessing}
              >
