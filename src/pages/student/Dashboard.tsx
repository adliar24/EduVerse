      ...
      {recentResults.filter(r => r.status === 'ongoing').length > 0 && (
        <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-3xl p-6 text-white shadow-xl">
          <div className="flex items-center justify-between">
            ...
            <Link 
              to="/daftar-ujian-siswa"
              className="bg-white text-amber-600 px-6 py-3 rounded-full font-bold hover:bg-amber-50 transition-all flex items-center gap-2"
            >
              Lanjutkan
            ...
            <div key={result.id} className={cn(
              ...
              <div className="flex items-center gap-4">
                {result.status === 'ongoing' ? (
                  <Link 
                    to="/daftar-ujian-siswa"
                    className="bg-amber-500 text-white px-5 py-2.5 rounded-full font-bold hover:bg-amber-600 transition-all flex items-center gap-2"
                  >
                    Lanjutkan
                    <ArrowUpRight className="w-4 h-4" />
                  </Link>
