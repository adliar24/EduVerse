...
export const Input: React.FC<InputProps> = ({ label, className = '', ...props }) => {
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <input 
        className={`w-full bg-white text-gray-900 border border-gray-200 rounded-2xl px-4 py-3 text-base placeholder:text-gray-400 focus:border-[#3B66F5] focus:ring-2 focus:ring-[#3B66F5]/20 transition-all outline-none ${className}`}
        {...props}
      />
    </div>
  );
