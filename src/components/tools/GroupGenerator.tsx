      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            {activeStudents.length > 0 && (
              <div className="space-y-3">
                 <div className="flex items-center justify-between border-b border-slate-100 pb-2 mb-2">
                    ...
                    <button 
                      onClick={handleReset} 
                      className="text-xs text-red-600 hover:text-red-700 font-bold flex items-center gap-1 bg-red-50 px-2 py-1 rounded transition-colors cursor-pointer"
                    >
                        ...
                        <div key={s.id} className="text-sm px-3 py-2 bg-slate-50 border border-slate-100 rounded-lg flex justify-between items-center group hover:bg-slate-100 transition-colors">
                          <span className="flex items-center gap-2 truncate text-slate-700">
                            ...
                            <button
                              ...
                              className={`text-[9px] px-1.5 rounded font-bold border cursor-pointer transition-all hover:scale-105 ${
                          ...
                          <button 
                            ...
                            className="text-slate-400 hover:text-red-600 transition-colors p-1 rounded hover:bg-slate-200 cursor-pointer"
        ...
        <div className="flex flex-col gap-6">
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold text-lg shadow-lg flex items-center justify-center gap-3 transition-all transform active:scale-95 cursor-pointer ${
