...
export function AlertProvider({ children }: { children: ReactNode }) {
  ...
  const showAlert = (newOptions: AlertOptions) => {
    // Auto-show toast for success/error without needing user interaction ONLY if there's no detailed message
    if ((newOptions.type === 'success' || newOptions.type === 'error') && !newOptions.message && !newOptions.showConfirmButton && !newOptions.onConfirm) {
